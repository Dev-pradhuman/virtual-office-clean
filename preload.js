...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  verifyQuitPassword: (password) => ipcRenderer.invoke('verify-quit-password', password),
  onPromptQuitPassword: (callback) => ipcRenderer.on('prompt-quit-password', () => callback()),
